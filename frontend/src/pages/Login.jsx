    ...
    <div className="relative flex items-center justify-center min-h-screen bg-slate-900 overflow-hidden font-sans">
      ...
      <div className="relative z-10 w-full max-w-md p-8 m-4 rounded-3xl border border-slate-800/80 bg-slate-950/80 backdrop-blur-xl shadow-2xl slide-in">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-xs text-slate-400 mt-1">Placement Analytics & ML Portal</p>
        </div>
        ...
        <div className="mt-6 p-4 rounded-2xl bg-slate-900/40 border border-slate-800 text-center">
          <div className="flex items-center justify-center space-x-1.5 text-xs font-semibold text-amber-400 mb-2">
            <Sparkles size={14} />
            <span>Developer Demo Account</span>
          </div>
          <p className="text-[11px] text-slate-400 mb-3">
            Click below to automatically fill in pre-configured administrator credentials.
          </p>
          <button
            type="button"
